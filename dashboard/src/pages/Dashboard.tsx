...
//   // Si le montant est déjà en FCFA, utilisez-le directement
...
// // Formatage nombre FCFA
// // Fonction pour obtenir un nombre formaté sans devise
...
//     error: ordersError,
//   } = useQuery<{ content?: RecentOrder[] }>({
//     queryKey: ["dashboardRecentOrders", filters],
//     queryFn: () =>
...
//     return {
//       ...d,
//       revenue: d.revenue || 0, // Utilise directement le montant FCFA
//       name:
...
//     // 1. Définissez le nom et le type du fichier XLSX
...
//     try {
//       // const responseArrayBuffer = await apiClient.exportFullReport({
//       //     startDate: filters.startDate ? new Date(filters.startDate) : undefined,
//       //     endDate: filters.endDate ? new Date(filters.endDate) : undefined,
//       //     // Ajoutez d'autres filtres si nécessaire
//       // });

//       //const blob = new Blob([responseArrayBuffer], { type: excelMimeType });
...
//       // Gérer l'affichage d'une alerte utilisateur ici
//     }
//   };
...
//           {/* Ici, vous intégreriez un tableau de données (datatable)
//         qui utilise les filtres (filters.startDate, filters.endDate, etc.)
//         et affiche 50 ou 100 lignes à la fois. */}
//         </DialogContent>
//       </Dialog>
